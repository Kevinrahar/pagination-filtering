...
<div class="container">
    <br>
    <h3>Tambah Data</h3>
<form method="post" action="<?php echo base_url('index.php/pagination/insert') ?>">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir" placeholder="tanggal_lahir" value="<?php echo date('Y-m-d')?>">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="club" id="club" placeholder="club">
  </div>
  <div class="form-group">
